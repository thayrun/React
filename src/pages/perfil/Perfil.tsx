...
function Perfil() {
  let navigate = useNavigate()
    ...
    useEffect(() => {
        if (usuario.token === "") {
          toastAlert('Você foi logado com sucesso', 'info')
            navigate("/login")
        }
    }, [usuario.token])
  ...
  return (
    <div className='container mx-auto mt-4 rounded-2xl overflow-hidden'>
      <img className='w-full h-72 object-cover border-b-8 border-white' src=""/*Não esquecer de colocar foto de Capa */ alt="Capa do Perfil" />
